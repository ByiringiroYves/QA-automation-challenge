    ...
    // Confirm Delete Modal
      ...
      async fillUserForm(name, email, role = 'User') {
    ...
    async assertUserInList(user) {
       console.log('assertUserInList: User object received:', user); // ADD THIS LINE
       console.log('assertUserInList: User name being used:', user.name); // ADD THIS LINE
    ...
    async assertUserNotInList(name) {
